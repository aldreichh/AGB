...
<body>
    ...
    <div class="contents">
        ...
        <div class="addcontainer">
            <div class="addcontainer2">
                ...
                <input type="date" class="dateofpurchase" id="start" name="date"
                       value="2022-01-01"
                       min="2020-01-01" max="2050-01-01"/>    
                <div class="textfields">
                    <input class="productname" type="text" name="productname" placeholder="Product Name" required/> <br>
                    <input class="quantity" type="text" name="quantity" placeholder="Quantity" required/> <br>
                    <input class="price" type="text" name="price" placeholder="Price" required/> <br>
                </div>
                <div class="buttons">
    ...
    if(isset($_POST['productname']) && isset($_POST['quantity']) && isset($_POST['price']))
    {
        ...
        $sql = "INSERT INTO products (date, product_name, quantity, unit_price, available_balance)
       VALUES ('$date', '$productname' , '$quantity', '$price', '$available_balance')";
